    ...
    <div className="w-full bg-black text-center flex flex-col items-center overflow-hidden">
        ...
        <Navbar />
          <Fade direction={'up'} triggerOnce={true}>
            <h1 className="poppins text-white mt-20 px-4 md:px-0 text-3xl md:text-[4rem] font-extrabold leading-[175%] md:leading-[135%]">Minimize your tabs.<br/>Find the trends!</h1>
          </Fade>
